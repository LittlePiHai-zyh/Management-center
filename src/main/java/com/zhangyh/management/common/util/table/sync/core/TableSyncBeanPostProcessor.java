package com.zhangyh.management.common.util.table.sync.core;
...
import com.zhangyh.management.common.util.table.sync.sql.script.SqlBuilder;
...
import com.zhangyh.management.common.util.table.sync.sql.table.TypeConvert;
import com.zhangyh.management.common.util.table.sync.util.StringUtil;
...
//                System.out.printf("%-20s%-20s%-10s%-20s%-20s%-20s%s\n", columnName, columnType, isNullable, defaultValue, comment,columnKey,columnExtra);
    ...
    private TableSchema buildTableSchema(Object c) {
        ...
        for (Field declaredField : declaredFields) {
            ...
            com.zhangyh.management.common.util.table.sync.annotation.Field field = declaredField.getAnnotation(com.zhangyh.management.common.util.table.sync.annotation.Field.class);
            if (field != null) {
