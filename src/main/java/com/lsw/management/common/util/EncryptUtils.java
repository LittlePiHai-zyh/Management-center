...
public class EncryptUtils {
    ...
    public static RsaKeyPair generateKeyPair() throws NoSuchAlgorithmException {
        ...
        final String publicKeyString = Base64.encode(publicKey.getEncoded());
        final String privateKeyString = Base64.encode(privateKey.getEncoded());
    ...
    public static String decryptByPrivateKey(String privateKey,String context) throws Exception {
        ...
        byte[] result = doLongerCipherFinal(Cipher.DECRYPT_MODE, cipher, Base64.decode(context));
    ...
    public static Object get(String filename, String algorithm, boolean isPrivateKey, String header)
        ...
        byte[] derBytes = Base64.decode(base64String);
...
//        保存公钥私钥
        ...
        der2pem(Base64.decode(keyPair.getPrivateKey()),privateKeyHeader,privateKeyFile);
        der2pem(Base64.decode(keyPair.getPublicKey()),publicKeyHeader,publicKeyFIle);
//        PrivateKey privateKey = get("server.key");
        ...
        System.out.println(Base64.encode(privateKey.getEncoded()).equals(keyPair.getPrivateKey()));
