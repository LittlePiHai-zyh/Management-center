package com.lsw.management.common.util.table.sync.sql.script;
...
import com.lsw.management.common.util.table.sync.sql.table.mysql.index.MUL;
import com.lsw.management.common.util.table.sync.sql.table.mysql.index.PRI;
import com.lsw.management.common.util.table.sync.sql.table.mysql.index.UNI;
...
public class SqlBuilder {
    ...
    public String buildFieldSql(TableSchema.Field filed) {
        ...
        String name = StringUtil.toUnderScoreCase( filed.getName());
