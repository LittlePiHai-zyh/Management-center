...
import com.lsw.management.common.util.table.sync.sql.script.SqlBuilder;
import com.lsw.management.common.util.table.sync.sql.table.Index;
import com.lsw.management.common.util.table.sync.sql.table.IndexHelper;
import com.lsw.management.common.util.table.sync.sql.table.TableSchema;
import com.lsw.management.common.util.table.sync.sql.table.TypeConvert;
import com.lsw.management.common.util.table.sync.util.StringUtil;
...
//                System.out.printf("%-20s%-20s%-10s%-20s%-20s%-20s%s\n", columnName, columnType, isNullable, defaultValue, comment,columnKey,columnExtra);
    ...
    private TableSchema buildTableSchema(Object c) {
        ...
        for (Field declaredField : declaredFields) {
            ...
            com.lsw.management.common.util.table.sync.annotation.Field field = declaredField.getAnnotation(com.lsw.management.common.util.table.sync.annotation.Field.class);
            if (field != null) {
